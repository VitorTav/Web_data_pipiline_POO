CREATE TABLE DESPESAS_OPERACIONAIS_ARMAZEM
(
    ...
    VALOR_POR_EMPILHADEIRA VARCHAR(250) NULL,
    VALOR_TOTAL VARCHAR(250) NULL,
    VALOR_UNITARIO VARCHAR(250) NULL,
    _ID VARCHAR(250) NULL,
    PRIMARY KEY (`ID`)
) ENGINE = InnoDB;
ALTER TABLE `DESPESAS_OPERACIONAIS_ARMAZEM` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`);
ALTER TABLE `DESPESAS_OPERACIONAIS_ARMAZEM` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `DESPESAS_OPERACIONAIS_ARMAZEM` ADD INDEX( `_ID`);
