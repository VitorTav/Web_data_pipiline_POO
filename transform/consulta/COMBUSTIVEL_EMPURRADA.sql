CREATE TABLE dbfreightech.COMBUSTIVEL_EMPURRADA
    ...
    CREDITO_IMPOSTO VARCHAR(250) NULL,
...
ALTER TABLE `dbfreightech`.`COMBUSTIVEL_EMPURRADA` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`); 
ALTER TABLE `COMBUSTIVEL_EMPURRADA` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `COMBUSTIVEL_EMPURRADA` ADD INDEX( `_ID`);
