CREATE TABLE dbfreightech.DESPESAS_OPERACIONAIS_INSUMOS
...
ALTER TABLE `dbfreightech`.`DESPESAS_OPERACIONAIS_INSUMOS` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`); 
ALTER TABLE `DESPESAS_OPERACIONAIS_INSUMOS` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `DESPESAS_OPERACIONAIS_INSUMOS` ADD INDEX( `_ID`);
