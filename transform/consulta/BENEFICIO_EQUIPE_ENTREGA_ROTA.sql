CREATE TABLE dbfreightech.BENEFICIO_EQUIPE_ENTREGA_ROTA
(
...
ALTER TABLE `dbfreightech`.`BENEFICIO_EQUIPE_ENTREGA_ROTA` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`);
ALTER TABLE `BENEFICIO_EQUIPE_ENTREGA_ROTA` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `BENEFICIO_EQUIPE_ENTREGA_ROTA` ADD INDEX( `_ID`);
