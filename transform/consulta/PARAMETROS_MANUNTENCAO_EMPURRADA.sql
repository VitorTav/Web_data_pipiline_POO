CREATE TABLE dbfreightech.PARAMETROS_MANUNTENCAO_EMPURRADA
    ...
    MANUTENCAO_EXTRA VARCHAR(250) NULL,
    MANUTENCAO_REAIS_KM VARCHAR(250) NULL,
    _ID VARCHAR(250) NULL ,
 PRIMARY KEY (`ID`)) ENGINE = InnoDB;
ALTER TABLE `dbfreightech`.`PARAMETROS_MANUNTENCAO_EMPURRADA` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`); 
ALTER TABLE `PARAMETROS_MANUNTENCAO_EMPURRADA` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `PARAMETROS_MANUNTENCAO_EMPURRADA` ADD INDEX( `_ID`);
