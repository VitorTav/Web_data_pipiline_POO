CREATE TABLE dbfreightech.BENFICIOS_AS
...
ALTER TABLE `dbfreightech`.`BENFICIOS_AS` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`); 
ALTER TABLE `BENFICIOS_AS` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `BENFICIOS_AS` ADD INDEX( `_ID`);
