CREATE TABLE dbfreightech.BENEFICIOS_EQP_AS
...
ALTER TABLE `dbfreightech`.`BENEFICIOS_EQP_AS` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`); 
ALTER TABLE `BENEFICIOS_EQP_AS` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `BENEFICIOS_EQP_AS` ADD INDEX( `_ID`);
