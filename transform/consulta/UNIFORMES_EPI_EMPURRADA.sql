CREATE TABLE dbfreightech.UNIFORMES_EPI_EMPURRADA
...
ALTER TABLE `dbfreightech`.`UNIFORMES_EPI_EMPURRADA` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`); 
ALTER TABLE `UNIFORMES_EPI_EMPURRADA` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `UNIFORMES_EPI_EMPURRADA` ADD INDEX( `_ID`);
