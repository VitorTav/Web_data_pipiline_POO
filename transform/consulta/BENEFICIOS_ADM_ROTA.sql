CREATE TABLE dbfreightech.BENEFICIOS_ADM_ROTA 
...
PARTICIPACAO_DA_EMPRESA VARCHAR(250) NULL ,
...
ALTER TABLE `dbfreightech`.`BENEFICIOS_ADM_ROTA` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`); 
ALTER TABLE `BENEFICIOS_ADM_ROTA` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `BENEFICIOS_ADM_ROTA` ADD INDEX( `_ID`);
