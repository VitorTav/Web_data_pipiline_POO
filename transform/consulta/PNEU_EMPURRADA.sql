CREATE TABLE dbfreightech.PNEU_EMPURRADA
    ...
    TIPO_PNEU VARCHAR(250) NULL,
    VALOR VARCHAR(250) NULL,
    _ID VARCHAR(250) NULL ,
 PRIMARY KEY (`ID`)) ENGINE = InnoDB;
ALTER TABLE `dbfreightech`.`PNEU_EMPURRADA` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`); 
ALTER TABLE `PNEU_EMPURRADA` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `PNEU_EMPURRADA` ADD INDEX( `_ID`);
