CREATE TABLE dbfreightech.COMBUSTIVEL_AS
    ...
    PRECO_ANP VARCHAR(250) NULL,
    PRECO_CREDITO_IMPOSTOS VARCHAR(250) NULL,
    PRECO_OPERADORA VARCHAR(250) NULL,
    TIPO_COMBUSTIVEL_SHARED VARCHAR(250) NULL,
    _ID VARCHAR(250) NULL ,
 PRIMARY KEY (`ID`)) ENGINE = InnoDB;
ALTER TABLE `dbfreightech`.`COMBUSTIVEL_AS` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`); 
ALTER TABLE `COMBUSTIVEL_AS` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `COMBUSTIVEL_AS` ADD INDEX( `_ID`);
