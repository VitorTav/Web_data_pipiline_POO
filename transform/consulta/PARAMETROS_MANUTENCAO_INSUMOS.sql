CREATE TABLE PARAMETROS_MANUTENCAO_INSUMOS
(
    ...
    manutencaoExtra VARCHAR(250) NULL,
    manutencaoReaisKm VARCHAR(250) NULL,
    _id VARCHAR(250) NULL,
    PRIMARY KEY (`ID`)
) ENGINE = InnoDB;
ALTER TABLE `PARAMETROS_MANUTENCAO_INSUMOS` ADD UNIQUE `UNI_ID` (`Unidade_Nome`, `_id`);
ALTER TABLE `PARAMETROS_MANUTENCAO_INSUMOS` ADD INDEX( `Unidade_Nome`);
ALTER TABLE `PARAMETROS_MANUTENCAO_INSUMOS` ADD INDEX( `_id`);
