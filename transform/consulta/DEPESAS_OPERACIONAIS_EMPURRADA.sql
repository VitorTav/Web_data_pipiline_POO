CREATE TABLE dbfreightech.DEPESAS_OPERACIONAIS_EMPURRADA
( 
...
ALTER TABLE `dbfreightech`.`DEPESAS_OPERACIONAIS_EMPURRADA` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`); 
ALTER TABLE `DEPESAS_OPERACIONAIS_EMPURRADA` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `DEPESAS_OPERACIONAIS_EMPURRADA` ADD INDEX( `_ID`);
