CREATE TABLE dbfreightech.BENEFICIO_NOTURNA_AS
    ...
    BENEFICIOAS VARCHAR(250) NULL,
    CARGO VARCHAR(250) NULL,
    TOTAL_BENEFICIO VARCHAR(250) NULL,
    TURNO VARCHAR(250) NULL,
    _ID VARCHAR(250) NULL ,
 PRIMARY KEY (`ID`)) ENGINE = InnoDB;
ALTER TABLE `dbfreightech`.`BENEFICIO_NOTURNA_AS` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`); 
ALTER TABLE `BENEFICIO_NOTURNA_AS` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `BENEFICIO_NOTURNA_AS` ADD INDEX( `_ID`);
