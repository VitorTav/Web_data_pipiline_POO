CREATE TABLE DESPESAS_FIXAS_ARMAZEM
(
    ...
    DESCRICAO_DESPESA VARCHAR(250) NULL,
...
ALTER TABLE `DESPESAS_FIXAS_ARMAZEM` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`);
ALTER TABLE `DESPESAS_FIXAS_ARMAZEM` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `DESPESAS_FIXAS_ARMAZEM` ADD INDEX( `_ID`);