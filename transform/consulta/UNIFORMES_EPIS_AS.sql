CREATE TABLE dbfreightech.UNIFORMES_EPIS_AS
...
ALTER TABLE `dbfreightech`.`UNIFORMES_EPIS_AS` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`); 
ALTER TABLE `UNIFORMES_EPIS_AS` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `UNIFORMES_EPIS_AS` ADD INDEX( `_ID`);
