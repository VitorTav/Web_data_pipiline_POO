CREATE TABLE UNIFORMES_EPI_ARMAZEM
(
...
ALTER TABLE `UNIFORMES_EPI_ARMAZEM` ADD UNIQUE `UNI_ID` (`UNIDADE_NOME`, `_ID`);
ALTER TABLE `UNIFORMES_EPI_ARMAZEM` ADD INDEX( `UNIDADE_NOME`);
ALTER TABLE `UNIFORMES_EPI_ARMAZEM` ADD INDEX( `_ID`);
